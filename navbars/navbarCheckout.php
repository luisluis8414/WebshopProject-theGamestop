  ...
  <nav class="account">
    <ul class="nav__list__right">
      ...
      <div class="shopping-cart">
        <svg onclick="showCartAlert()" id="ShoppingCartIcon" style="color: white" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
      ...
      <li class="nav__list-item__right">
        <a id="logOutButton" class="nav__link__right nav__link--btn " id="LogOutButton" href="../../Verification/php/Login/logOut.php">Log Out</a>
      </li>
    </ul>
  </nav>
</header>